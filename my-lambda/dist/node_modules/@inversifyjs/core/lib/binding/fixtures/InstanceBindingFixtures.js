...
export class InstanceBindingFixtures {
    ...
    static get withScopeSingleton() {
        return {
            ...InstanceBindingFixtures.any,
            scope: bindingScopeValues.Singleton,
        };
    }
    static get withScopeTransient() {
        return {
            ...InstanceBindingFixtures.any,
            scope: bindingScopeValues.Transient,
        };
    }
    static get withCacheIsRightFalseAndScopeSingleton() {
        return {
    ...
    static get withCacheIsRightAndAsyncValueAndScopeSingleton() {
        return {
            ...InstanceBindingFixtures.withScopeSingleton,
            cache: {
                isRight: true,
    ...
    static get withCacheIsRightAndScopeSingleton() {
        return {
            ...InstanceBindingFixtures.withScopeSingleton,
            cache: {
                isRight: true,
...
//# sourceMappingURL=InstanceBindingFixtures.js.map