...
export type PlanServiceNodeParent<TActivated = any> = InstanceBindingNode<TActivated, InstanceBinding<TActivated>> | ResolvedValueBindingNode<ResolvedValueBinding<TActivated>>;
