...
export interface InstanceBindingNode<TActivated = any, TBinding extends InstanceBinding<TActivated> = InstanceBinding<TActivated>> extends ResolvableBindingNode<TActivated, TBinding> {
